            ...
            <div className="min-h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-gray-950 flex flex-col items-center justify-center p-8">
                <div className="max-w-2xl w-full space-y-6">
                    <div className="flex items-center justify-between mb-4">
                        <h1 className="text-4xl font-bold text-white">Pinyin Challenge</h1>
                        {isLoggedIn ? (
                            <button
                    ...
                    <div className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 border border-gray-700/50 rounded-lg p-6 space-y-4">
                        ...
                        <button
                            ...
                            className={`w-full py-4 rounded-lg font-semibold text-lg transition-all duration-300 ${addedWords.length === 0
                                ? 'bg-gray-700/50 text-gray-500 cursor-not-allowed'
                                : 'bg-gradient-to-r from-cyan-500 to-cyan-600 text-white hover:from-cyan-400 hover:to-cyan-500 hover:shadow-[0_0_20px_rgba(6,182,212,0.5)] cursor-pointer hover:scale-102'
                                }`}
                        >
                            Start Game
                        </button>
                        <a href="/settings">
                            <button
                                className={`w-full py-4 rounded-lg font-semibold text-lg transition-all duration-300 bg-gradient-to-r from-gray-500 to-gray-600 text-white hover:from-gray-400 hover:to-gray-500 hover:shadow-[0_0_20px_rgba(6,6,6,0.5)] cursor-pointer hover:scale-102'
                                    `}
                            >
                                Settings
                            </button>
                ...
                <div className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 border border-gray-700/50 rounded-lg p-12 text-center space-y-8">
                    ...
                    <div className="space-y-4">
                        <input
                            ...
                            className={`w-full px-6 py-4 text-2xl text-center rounded-lg bg-gray-800/50 border transition-all duration-200 ${currentWord && removeTones(userInput.trim().toLowerCase()) === removeTones(currentWord.pinyin.toLowerCase())
