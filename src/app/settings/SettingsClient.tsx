...
const SettingsClient = () => {
    ...
    return (
        ...
        <div className="grid grid-cols-2 h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-gray-950 overflow-hidden">
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <button
                                            ...
                                            className={`absolute top-4 right-4 z-20 w-8 h-8 rounded-lg flex items-center justify-center transition-all duration-300 ${
                                                isAdded 
            ...
            <div className="m-4 text-xl flex flex-col gap-4 h-full min-h-0">
                <h1 className="bg-gradient-to-r from-gray-800 to-gray-700 p-3 rounded-lg text-white font-semibold border border-gray-600/50 shadow-lg flex-shrink-0">Current Words ({addedWords.length})</h1>
                {addedWords.length > 0 ? (
                    <div className="flex flex-col flex-1 min-h-0 space-y-2">
